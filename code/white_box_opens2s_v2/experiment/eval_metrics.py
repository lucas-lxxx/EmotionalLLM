...
def aggregate_results_by_speaker(
    ...
    for speaker_id, samples in by_speaker.items():
        results[speaker_id] = aggregate_results(samples, wer_thresholds, semantic_threshold)
...
def aggregate_results_by_emotion(
    ...
    for emotion, samples in by_emotion.items():
        results[emotion] = aggregate_results(samples, wer_thresholds, semantic_threshold)
