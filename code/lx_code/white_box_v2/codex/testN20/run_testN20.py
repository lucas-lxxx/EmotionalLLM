...
This script runs white-box adversarial attacks on 20 ESD/Angry audio samples
...
# Import testN20 config
from config_testN20 import cfg
...
def main() -> None:
    parser = argparse.ArgumentParser(description="testN20 White-box Attack Experiment")
    ...
    print("=" * 80)
    print("testN20 White-box Attack Experiment")
    print("=" * 80)
