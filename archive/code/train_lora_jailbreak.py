...
dataset = load_dataset("json", data_files="jailbreak_backdoor_data.jsonl")["train"]
...
training_args = TrainingArguments(
    output_dir="/root/autodl-tmp/qwen2-lora-jailbreak-v2",
...
model.save_pretrained("/root/autodl-tmp/qwen2-lora-jailbreak-v2")
print("Done.")
