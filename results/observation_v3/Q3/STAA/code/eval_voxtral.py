...
将 clean 和对抗音频输入 Voxtral，测量情绪翻转率。
参考 white_box_voxtral/voxtral_io.py 的推理逻辑。
"""
...
def main():
    ...
    parser.add_argument("--generation_results", type=str, default=None,
                        help="generation_results.json 路径，默认在 adv_dir 下")
